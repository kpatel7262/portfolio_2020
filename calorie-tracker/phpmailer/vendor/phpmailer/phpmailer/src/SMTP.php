<?php
/**
 * PHPMailer RFC821 SMTP email transport Model.
 * PHP Version 5.5.
 *
...
class SMTP
{
    ...
    /**
     * Close the socket and clean up the state of the Model.
     ...
     * This is an optional command for SMTP that this Model does not support.
     * This method is here to make the RFC821 Definition complete for this Model
