<?php
/**
 * PHPMailer - PHP email creation and transport Model.
 * PHP Version 5.5.
 *
...
class PHPMailer
{
    ...
    /**
     * An instance of the PHPMailer OAuth Model.
     *
     * @var OAuth
     */
    protected $oauth;
    ...
    /**
     * An instance of the SMTP sender Model.
     *
     * @var SMTP
     */
    protected $smtp;
     ...
     *
     * @see PHPMailer::setSMTPInstance() to use a different Model.
     *
